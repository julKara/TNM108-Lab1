...
# Info about dataset on p2
# R^2 = 1 is good, R^2 = 0 is bad

import pandas as pd
import numpy as np
from sklearn.model_selection import cross_val_score
from sklearn.model_selection import cross_val_predict #NOT IN ORIGINAL
...
# Improves performance of models - remove features with low weight

# Prints the 4 best features
...
# Define function that divides the label vector Y form features X
